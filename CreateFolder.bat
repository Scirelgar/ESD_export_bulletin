...
:: Variables
set dirInput=C:\Users\samue\�cole Secondaire Duval\Site �tablissements scolaires - Partage de fichier\input
set dirNuage=C:\Users\samue\�cole Secondaire Duval\Site �tablissements scolaires - Partage de fichier\Nuage(output)
