...
:: Variables
set dirInput=%USERPROFILE%\�cole Secondaire Duval\Communications Interscolaire ESD - Partage de fichiers\input
set dirNuage=%USERPROFILE%\�cole Secondaire Duval\Communications Interscolaire ESD - Partage de fichiers\Nuage(output)
set dirEngine=%USERPROFILE%\�cole Secondaire Duval\Communications Interscolaire ESD - Partage de fichiers\Engine
set folderA=
set folderName=
